...
public class Solution336PalindromePairs {
	/*
	...
	private void getPalindromePairs(String[] words, List<List<Integer>> result, TrieTreeNode root) {
	...
	private void hasMirrors(TrieTreeNode root, StringBuilder builder, HashSet<Integer> set) {
	...
	private void search(TrieTreeNode root, char[] word, int index, HashSet<Integer> set) {
